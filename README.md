...
#
# Copyright (C) 2021 POSROG Project - modified and ported by Team Posrog Indo
#
...
function init_misc()
{
  ...
  setprop ro.product.model "ASUS_I005DA"
  setprop ro.product.name "android_x86_64"
  setprop ro.phoenix.version.codename "V3U8  |  GARUDA  |  OFFICIAL"
  setprop ro.build.fingerprint "asus/WW_I005DA/ASUS_I005DA_1:7.1.2/N2G48H/16.0631.1910.64-0:user/release-keys"
  ...
  # enable virt_wifi if needed (converting ethernet to virt_wifi) 
...
function init_hal_hwcomposer()
{
  ...
  [ "$HWC" = "drm" ]  [ "$HWC" = "drm_minigbm" ] && set_property vendor.hwc.backend_override client
  return
}
